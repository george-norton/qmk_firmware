...
//            LMB, RMB, LAYER 1 (HOLD) MMB, mute on teams, ENTER
//            BOOT MODE, RGB MODE FORWARD, transparent, RGB MODE BACK, RGB ON/OFF
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT(KC_BTN1, KC_BTN2, LT(1, KC_BTN3), LCMD(S(KC_M)), KC_ENTER),
                                                              [1] = LAYOUT(QK_BOOT, RGB_MOD, KC_TRNS, RGB_RMOD, RGB_TOG),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [0] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),  ENCODER_CCW_CW(KC_DOWN, KC_UP)  },
    [1] = { ENCODER_CCW_CW(RGB_HUI, RGB_HUD),   ENCODER_CCW_CW(RGB_SAI, RGB_SAD)  },
